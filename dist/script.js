...
window.addEventListener('DOMContentLoaded', function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                throw new Error("Could not fetch ".concat(this.url, ", status: ").concat(res.status));
  ...
  new PhotoItem().render(); // new PhotoItem().getImage();
