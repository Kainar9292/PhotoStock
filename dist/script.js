...
window.addEventListener('DOMContentLoaded', function () {
  ...
  function () {
    function PhotoItem() {
      ...
      this.historyHeader = document.querySelector('.header__history'); // window.onresize = () => window.location.reload();

      this.staticEventHandler(); // this.getImage(this.url);
    } // generate HTML img
    ...
    _createClass(PhotoItem, [{
      ...
      value: function spinnerToHtml() {
        ...
        var statusSpinner = document.querySelector('.main__spinner');
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                this.statusMessage.src = 'assets/img/spinner.svg';
                this.statusMessage.classList.add('main__spinner');
                statusSpinner = document.querySelector('.main__spinner');

                if (statusSpinner) {
                  statusSpinner.remove();
                }

                this.wrapper.insertAdjacentElement('afterend', this.statusMessage); //Fetch DB
        ...
        return regeneratorRuntime.async(function getImage$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                data = _context2.sent;
                this.render(data); //remove spinner
      ...
      value: function staticEventHandler() {
        ...
        var resize = function resize(e) {
          var changeCounter = _this4.counterMax;
          ...
          if (changeCounter != _this4.counterMax) {
            ...
            _this4.inputSearch.setAttribute('data-load', 'base');
